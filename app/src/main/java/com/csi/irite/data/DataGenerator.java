...
import com.csi.irite.model.CardViewImg;
import com.csi.irite.model.Image;
import com.csi.irite.model.Inbox;
import com.csi.irite.model.MusicAlbum;
import com.csi.irite.model.MusicSong;
import com.csi.irite.model.News;
import com.csi.irite.model.People;
import com.csi.irite.model.ShopCategory;
import com.csi.irite.model.ShopProduct;
import com.csi.irite.model.Social;
import com.csi.irite.utils.MaterialColor;
...
public class DataGenerator {
    ...
    public static List<Image> getImageDate2(Context ctx) {
        List<Image> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.sample_images);
        String name_arr[] = ctx.getResources().getStringArray(R.array.sample_images_name);
        String date_arr[] = ctx.getResources().getStringArray(R.array.general_date);
   ...
   /*
    public static List<Image> getIntroData(Context ctx) {
        List<Image> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.photo_illustration);
        String title[] = ctx.getResources().getStringArray(R.array.strings_wizard_title);
        String content[] = ctx.getResources().getStringArray(R.array.strings_wizard_content);
        for (int i = 0; i < drw_arr.length(); i++) {
            Image obj = new Image();
            obj.image = drw_arr.getResourceId(i, -1);
            obj.name = title[i];
    ...
    public static List<Image> getIntroOrangeData(Context ctx) {
        List<Image> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.photo_illustration_orange);
        String title[] = ctx.getResources().getStringArray(R.array.strings_wizard_title);
        String content[] = ctx.getResources().getStringArray(R.array.strings_wizard_content);
        for (int i = 0; i < drw_arr.length(); i++) {
            Image obj = new Image();
    ...
    public static List<Image> getIntroHealthData(Context ctx) {
        List<Image> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.photo_illustration_health);
        String title[] = ctx.getResources().getStringArray(R.array.strings_wizard_title);
        String content[] = ctx.getResources().getStringArray(R.array.strings_wizard_content);
        for (int i = 0; i < drw_arr.length(); i++) {
            Image obj = new Image();
    ...
    public static List<Image> getIntroShopData(Context ctx) {
        List<Image> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.photo_illustration_shop);
        String title[] = ctx.getResources().getStringArray(R.array.strings_wizard_title);
        String content[] = ctx.getResources().getStringArray(R.array.strings_wizard_content);
        for (int i = 0; i < drw_arr.length(); i++) {
            Image obj = new Image();
